<?php
	...
	$option2['sfsi_plus_mastodon_pageUrl'] 	=	(isset($option2['sfsi_plus_mastodon_pageUrl']))
														? sanitize_text_field($option2['sfsi_plus_mastodon_pageUrl'])
														: '';
...
<div class="tab2">
    ...
    <div class="row sfsiplus_email_section">
        ...
        <div class="inr_cont">
			<p class="sfsi_plus_specificfeedlink">
				<?php _e('It allows your visitors to subscribe to your site (on ', 'ultimate-social-media-plus' ); ?><a href="https://api.follow.it/widgets/emailSubscribeEncFeed/<?php echo $feedId; ?>/<?php echo base64_encode(8); ?>" target="_new"><?php _e( 'this screen', 'ultimate-social-media-plus' ); ?></a><?php _e(") and receive new posts automatically by email.", 'ultimate-social-media-plus' ); ?>
			</p>
            ...
            <div class='sfsi_plus_service_row'>
            	<div class='sfsi_plus_service_column'>
            		<ul>
            			<li><span><?php _e( 'More people come back', 'ultimate-social-media-plus' ); ?></span><?php _e( ' to your site', 'ultimate-social-media-plus' ); ?></li>
            			<li><?php _e( 'See your ', 'ultimate-social-media-plus' ); ?><span><?php _e( 'subscribers’ emails', 'ultimate-social-media-plus' ); ?></span><?php _e( ' & ', 'ultimate-social-media-plus' ); ?><span><?php _e( 'interesting statistics', 'ultimate-social-media-plus' ); ?></span></li>
            			<li><?php _e( 'Automatically post on ', 'ultimate-social-media-plus' ); ?><span><?php _e( 'Facebook & X (Twitter)', 'ultimate-social-media-plus' ); ?></span></li>
	            	</ul>
            	</div>
                <div class='sfsi_plus_service_column'>
                	<ul>
		                <li><span><?php _e( 'Get more traffic', 'ultimate-social-media-plus' ); ?></span><?php _e( ' by being listed in the follow.it directory', 'ultimate-social-media-plus' ); ?></li>
		                <li><span><?php _e( 'Get alerts', 'ultimate-social-media-plus' ); ?></span><?php _e( ' when people subscribe or unsubscribe', 'ultimate-social-media-plus' ); ?></li>
		                <li><span><?php _e( 'Tailor the sender name & subject line', 'ultimate-social-media-plus' ); ?></span><?php _e( ' of the emails', 'ultimate-social-media-plus' ); ?></li>
	                </ul> 
	            </div>   
           ...
           <?php if($option2['sfsi_plus_premium_email_box'] =='yes') { ?>
            <div class ="sfsi_plus_new_prmium_follw">
				<p>	
					<b><?php _e( 'New:', 'ultimate-social-media-plus' ); ?></b><?php _e( ' In our Premium Plugin you can now give your email icon other functions too, e.g. contact you (email), share by email, and link to a certain page (e.g. your contact form or newsletter sign-up site). ', 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=more_functions_email_icon&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>
				</p>
            </div>
            <?php } ?>
        </div>
    ...
    <div class="row sfsiplus_facebook_section">
        ...
        <div class="inr_cont">
            ...
            <div class="sfsi_plus_new_prmium_follw">
				<p>
					<b><?php _e( 'New:', 'ultimate-social-media-plus' ); ?></b>	<?php _e( ' In our Premium Plugin you can also allow users to follow you on Facebook directly from your site (without leaving your page, increasing followers). ', 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=direct_follow_facebook&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>					
				</p>
            </div>
            <?php } ?>
    ...
    <div class="row sfsiplus_twitter_section">
        ...
        <div class="inr_cont twt_tab_2">
             ...
             <div class="radio_section fb_url twt_fld">
                ...
                <input name="sfsi_plus_twitter_followUserName" type="text" value="<?php echo ($option2['sfsi_plus_twitter_followUserName']!='') ? $option2['sfsi_plus_twitter_followUserName'] : '' ;?>" placeholder="my_x_twitter_name" class="add" />
             </div>
             <div class="radio_section fb_url twt_fld_2">
                ...
                <textarea name="sfsi_plus_twitter_aboutPageText" id="sfsi_plus_twitter_aboutPageText" type="text" class="add_txt" placeholder="<?php _e( 'Hey check out this cool site I found', 'ultimate-social-media-plus' ) ;?>: www.yourname.com #Topic via@my_x_twitter_name" /><?php echo ($option2['sfsi_plus_twitter_aboutPageText']!='') ? stripslashes($option2['sfsi_plus_twitter_aboutPageText']) : _e( 'Hey check out this cool site I found', 'ultimate-social-media-plus' ) ;?></textarea>
             </div>
            <?php if($option2['sfsi_plus_premium_twitter_box'] =='yes') { ?>
            <div class= "sfsi_plus_new_prmium_follw">
				<p>
					<b><?php _e( 'New: ', 'ultimate-social-media-plus' ); ?></b><?php _e(  "Posting on X becomes really fun in the Premium Plugin – you can insert tags to automatically pull the title of the story & link to the story, attach pictures & snippets to the X Posts (X (Twitter) cards) and use url-shorteners, all leading to more X Posts and traffic for your site! ", 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=better_tweets&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>
			    </p>
			</div>
            <?php } ?>
        </div>
        ...
        <div class="inr_cont utube_inn">
            ...
            <p class="radio_section fb_url"><input name="sfsi_plus_youtube_follow" <?php echo ($option2['sfsi_plus_youtube_follow']=='yes') ? 'checked="true"' : '' ;?> type="checkbox" value="yes" class="styled"  />
            	<label class="sfsi_label_utube_2">
            		...
            		<span>
            			<?php _e( '(it allows people to subscribe to you directly, without leaving your blog)', 'ultimate-social-media-plus' ); ?>
            		</span>
                </label>
            </p>
    ...
    <div class="row sfsiplus_pinterest_section">
        ...
        <div class="inr_cont">
			...
			<div class= "sfsi_plus_new_prmium_follw">
			<p>
				<b><?php _e( 'New: ', 'ultimate-social-media-plus' ); ?></b><?php _e(  "The Premium Plugin allows you to show a Pinterest icon if visitors move their mouse over your images. You can define exactly where it should show, and where not. ", 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=pinterest&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>
		    </p>
		</div>
		</div>
    ...
    <div class="row sfsiplus_linkedin_section">
        ...
        <div class="inr_cont linked_tab_2 link_in">
            ...
            <p>
            	<?php _e( 'You can find your ID in the link of your profile page, e.g. https://www.linkedin.com/profile/view?id=<b>8539887</b>&trk=nav_responsive_tab_profile_pic', 'ultimate-social-media-plus' ); ?>
           </p>
            <p>
    ...
    <div class="row sfsiplus_houzz_section">
        ...
        <div class="inr_cont">
            <p>
            	<?php _e( 'Please provide the url to your Houzz profile (e.g. http://www.houzz.com/user/your_username).', 'ultimate-social-media-plus' ); ?>  
			</p> 
...
<!--MZ CODE START-->	 
    ...
    <div class="row sfsiplus_ok_section">
		...
		<div class="inr_cont">
			<p>
				<?php _e( 'When clicked on, users will get directed to your OK page.', 'ultimate-social-media-plus' ); ?>
			</p>
			...
			<div class= "sfsi_plus_new_prmium_follw">
			<p>
				<b><?php _e( 'New: ', 'ultimate-social-media-plus' ); ?></b><?php _e(  "In our Premium Plugin you can now give OK icon other functions too, e.g. <b>like your website/blog, subscribe/follow you</b> on OK. ", 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=ok_like_and_subscribe&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>
		    </p>
		</div>
		</div>
    </div>
    ...
    <div class="row sfsiplus_telegram_section">
		...
		<div class="inr_cont">
			<p>
				<?php _e( 'Clicking on this icon will allow users to contact you on Telegram.', 'ultimate-social-media-plus' ); ?>
			</p>
			...
			<div class="radio_section fb_url ">
				...
				<label class="sfsiLabel1 sfsiLabel" >
					<?php _e("Pre-filled message:", 'ultimate-social-media-plus' );?>
				</label>
			...
			<div class="radio_section fb_url ">
				<label class="sfsiLabel1 sfsiLabel" >
					<?php _e("My Telegram username:", 'ultimate-social-media-plus' );?>
				</label>
			...
			<div class= "sfsi_plus_new_prmium_follw">
			<p>
				<b><?php _e( 'New: ', 'ultimate-social-media-plus' ); ?></b><?php _e(  " In our Premium Plugin you can now give your Telegram icon sharing functionality too, e.g. share your website/blog with friends. ", 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=telegram_sharing&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>
		    </p>
		</div>
		</div>
    ...
    <div class="row sfsiplus_vk_section">
		...
		<div class="inr_cont">
			<p>
				<?php _e( 'When clicked on, users will get directed to your VK page.', 'ultimate-social-media-plus' ); ?>
			</p>
			...
			<div class= "sfsi_plus_new_prmium_follw">
				<p>
					...
					<?php _e(  "In our Premium Plugin you can now give your VK icon sharing functionality too, e.g. <b>share your website/blog</b> with friends. ", 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=vk_share&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>
				</p>
			</div>
		</div>
    </div>
    ...
    <div class="row sfsiplus_wechat_section" style="display: <?php echo isset($option1["sfsi_plus_wechat_display"])&&$option1["sfsi_plus_wechat_display"]=="yes"?'block':'none';  ?>">
		...
		<h2 class="sfsicls_wechat">
			<?php _e( 'WeChat', 'ultimate-social-media-plus' ); ?>
		</h2>

		<div class="inr_cont">
			<p class="sfsiLabel infoLabel">
				<?php _e( 'When clicked on, your website/blog will be shared on WeChat.', 'ultimate-social-media-plus' ); ?>
			</p>
			<div class="radio_section fb_url ">
			...
			<p>
				<b><?php _e( 'New: ', 'ultimate-social-media-plus' ); ?></b>
				<?php _e(  "In our Premium Plugin you can also allow users to <b>follow you</b> on WeChat. ", 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=wechat_sharing&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>
		    </p>
		</div>
		</div>
	</div>
    ...
    <div class="row sfsiplus_whatsapp_section" style="display: <?php echo isset($option1["sfsi_plus_whatsapp_display"])&&$option1["sfsi_plus_whatsapp_display"]=="yes"?'block':'none';  ?>">
		...
		<div class="inr_cont">
			<p class="sfsiLabel infoLabel">
				<?php _e( 'When clicked on, your website/blog will be shared on WhatsApp.', 'ultimate-social-media-plus' ); ?>
			</p>
			<div class= "sfsi_plus_new_prmium_follw">
			<p>
				<b><?php _e( 'New: ', 'ultimate-social-media-plus' ); ?></b>
				<?php _e(  "In our Premium Plugin you can define what text will get shared, and also give the icon the feature to send you a WhatsApp message. ", 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=whatsapp_sharing&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>
		    </p>
		</div>
		</div>
	</div>
    ...
    <div class="row sfsiplus_weibo_section">
    	...
    	<h2 class="sfsicls_weibo">
			<?php _e( 'Sina Weibo', 'ultimate-social-media-plus' ); ?>
		</h2>
		<div class="inr_cont">
			<p class="sfsiLabel infoLabel">
				<?php _e( 'When clicked on, users will get directed to your Weibo page.', 'ultimate-social-media-plus' ); ?>
			</p>
			<div class="radio_section fb_url ">
			...
			<p>
				<b><?php _e( 'New: ', 'ultimate-social-media-plus' ); ?></b>
				<?php _e(  " In our Premium Plugin you can now give Weibo icon other functions too, e.g. <b>like your website/blog, share your website/blog</b> on Weibo. ", 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=weibo_like_and_share&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>
		    </p>
		</div>
		</div>
	...
	<div class="row sfsiplus_mastodon_section">
		...
		<h2 class="sfsicls_mastodon">
			<?php _e( 'Mastodon', 'ultimate-social-media-plus' ); ?>
		</h2>
		<div class="inr_cont">
			<p class="sfsiLabel infoLabel">
				<?php _e( 'When clicked on, users will get directed to your Mastodon profile page.', 'ultimate-social-media-plus' ); ?>
			</p>
			<div class="radio_section fb_url ">
                <label class="sfsiLabel">
                    URL:            	</label>
	            <input name="sfsi_plus_mastodon_pageUrl" type="url" placeholder="http://" value="<?php echo $option2['sfsi_plus_mastodon_pageUrl'];?>" class="add" />	        	
			</div>
			<div class= "sfsi_plus_new_prmium_follw">
			<p>
				<b><?php _e( 'New: ', 'ultimate-social-media-plus' ); ?></b>
				<?php _e(  " In our Premium Plugin you can now give Mastodon icon other functions too, e.g. <b>share your website/blog</b> on Mastodon. ", 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=mastodon_like_and_share&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>
		    </p>
		</div>
		</div>
    ...
    <!-- COPY LINK ICON -->
    	...
    	<div class="banner_custom_icon sfsi_plus_new_prmium_follw" style="<?php echo $bannerDisplay;?>">
			<p><b><?php _e( 'New:', 'ultimate-social-media-plus' ); ?></b>	<?php _e( ' In the Premium Plugin you can also give custom icons the feature that when people click on it, they can call you, or send you an SMS). ', 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=call_or_sms_feature_custom_icons&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank" style="font-family: inherit !important;"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>
			</p>
    	</div>

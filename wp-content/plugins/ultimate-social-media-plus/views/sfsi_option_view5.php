<?php
	...
	$prev_plugin_version = maybe_unserialize(get_option('sfsi_plus_was_installed_before', '0'));
	$was_installed_before = version_compare(SFSI_PLUS_PLUGIN_VERSION, $prev_plugin_version) >= 0;
	...
	$option5['sfsi_plus_mastodon_MouseOverText']= 	(isset($option5['sfsi_plus_mastodon_MouseOverText']))
														? sanitize_text_field($option5['sfsi_plus_mastodon_MouseOverText'])
														: '';
	...
	$sfsi_plus_show_admin_popup 				=   (isset($option5['sfsi_plus_show_admin_popup']))
														? sanitize_text_field($option5['sfsi_plus_show_admin_popup'])
														: 'yes';

	$sfsi_plus_icons_sharing_and_traffic_tips 				=   (isset($option5['sfsi_plus_icons_sharing_and_traffic_tips']))
														? sanitize_text_field($option5['sfsi_plus_icons_sharing_and_traffic_tips'])
														: 'yes';
    ...
    <ul class="plus_share_icon_order" >
     <?php
	 	...
	 	foreach($icons_order as $index=>$icn) :
		  ...
		  <?php case 'copylink' :?>
			<li class="sfsiplus_copylink_section " data-index="<?php echo $index; ?>" id="sfsi_plus_copylinkIcon_order">
				<a href="#" title="Copylink" ><img src="<?php echo SFSI_PLUS_PLUGURL; ?>images/icons_theme/default/default_copylink.png" alt="Copylink"  width="50px" height="50px"  /></a>
			</li>
		  <?php break; ?>

		  <?php case 'mastodon' :?>
			<li class="sfsiplus_mastodon_section " data-index="<?php echo $index; ?>" id="sfsi_plus_mastodonIcon_order">
...
<!--     	<div class="sfsi_plus_icons_prem_disc">
            <p class="sfsi_plus_prem_plu_desc">
				<b><?php  _e( 'New: ', 'ultimate-social-media-plus' ); ?></b><?php  _e( 'The Premium Plugin also allows you to define the vertical distance between the icons (and set this differently for mobile vs. desktop): ', 'ultimate-social-media-plus' ); ?><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=more_spacings&utm_medium=banner" target="_blank"><?php  _e( 'Check it out', 'ultimate-social-media-plus' ); ?></a>
			</p>
        </div> -->

		<div class="sfsi_plus_new_prmium_follw">
            <p>
				<b><?php  _e( 'New: ', 'ultimate-social-media-plus' ); ?></b><?php  _e( 'The Premium Plugin also allows you to define the vertical distance between the icons (and set this differently for mobile vs. desktop): ', 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus'); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=more_spacings&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus'); ?></a>
			</p>
		</div>
        ...
        <div class="icons_size">
        	<div style="width: 210px;float: left;position: relative;">
	        	...
	        	<ins class="sfsi_plus_icons_align_other" style="position: absolute;bottom: -22px;left: 0;width: 200px;color: rgb(128,136,145);">
	        		<?php  _e( '(with respect to each other)', 'ultimate-social-media-plus' ); ?>
	        	</ins>
	        </div>
        	<div class="field">
        	...
        	<ins>
        		<?php  _e( 'Leave empty if you don\'t want to define this', 'ultimate-social-media-plus' ); ?>
        	</ins>
        </div>
        <?php if($option5['sfsi_plus_premium_size_box'] == 'yes') { ?>
		<div class ="sfsi_plus_new_prmium_follw">
			<p>
				<b><?php  _e( 'New: ', 'ultimate-social-media-plus' ); ?></b><?php  _e( 'The Premium Plugin gives several more alignment options:', 'ultimate-social-media-plus' ); ?><br>- &nbsp;&nbsp;<?php  _e( ' Show icons vertically', 'ultimate-social-media-plus' ); ?><br>- &nbsp;&nbsp;<?php  _e( ' Align icons within a widget (left, right, centered)', 'ultimate-social-media-plus' ); ?><br>- &nbsp;&nbsp;<?php  _e( ' Align icons within the «container» where you place them via shortcode (left, right, centered)  ', 'ultimate-social-media-plus' ); ?>
				<br>
				<a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus'); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=more_alignment_options&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus'); ?></a>
			</p>
		</div>
		<?php } ?>
    </div>
...
<div class="row sfsi_custom_social_data_setting" id="custom_social_data_setting">
		...
		<h4><?php _e("Sharing texts & pictures?",'ultimate-social-media-plus'); ?></h4>
		<p><?php _e("On the pages where you edit your posts/pages, you’ll see a (new) section where you can define which pictures & text should be shared. This extra section is displayed on the following:",'ultimate-social-media-plus'); ?></p>
                ...
                <ul class="sfsi_show_hide_section">
               		<li>
						<div class="radio_section tb_4_ck">
							...
							<label class="cstmdsplsub"><?php _e("Hide section for all",'ultimate-social-media-plus'); ?></label>
						</div>
					</li>
                </ul>
		 </div>
		 ...
		 <!-- <ul class="social_data_post_types">
               		<li>
						<div class="radio_section tb_4_ck">
							...
							<label class="cstmdsplsub"><?php _e("Add the featured image to the RSS",'ultimate-social-media-plus'); ?></label>
						</div>
					</li>
                </ul> -->
		<div class="sfsi_plus_new_prmium_follw sfsi_social_sharing" style="margin-bottom: 15px;">
			<p><?php _e("Note: This feature is currently only available in the Premium Plugin.",'ultimate-social-media-plus'); ?> <a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  class="sfisi_plus_font_bold" target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus'); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=define_pic_and_text&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus'); ?></a>
			</p>
		</div>
</div>
...
<!--*************************************  Sharing texts & pictures section CLOSES *******************************************************************-->
    ...
    <div class="row new_wind">
        ...
        <div class="sfsiplus_row_onl">
        	<p>
				<?php
					_e( 'If the user clicks on your icons, do you want to open the page in a new window?','ultimate-social-media-plus' ); ?>
        	</p>
	...
	<div class="row new_wind usmi-pro-noopener" <?php if (!$was_installed_before || $option5['sfsi_plus_icons_ClickPageOpen'] == 'no') echo 'style="display: none;"'; ?> >
        <h4>
        ...
        <div class="sfsiplus_row_onl">
        	<p>
				<?php
					_e( 'Increases your site security.','ultimate-social-media-plus' ); ?>
        	</p>
            <ul class="enough_waffling">
                <li>
                    <input name="sfsi_plus_icons_AddNoopener" <?php echo ( $option5['sfsi_plus_icons_ClickPageOpen'] == 'yes' && $option5['sfsi_plus_icons_AddNoopener'] == 'yes' ) ? 'checked="true"' : '' ;?> type="radio" value="yes" class="styled"  />
                    <label>
                    	<?php  _e( 'Yes', 'ultimate-social-media-plus' ); ?>
                    </label>
                </li>
                <li>
                    <input name="sfsi_plus_icons_AddNoopener" <?php echo ( !($option5['sfsi_plus_icons_ClickPageOpen'] == 'yes' && $option5['sfsi_plus_icons_AddNoopener'] == 'yes' )) ? 'checked="true"' : '' ;?> type="radio" value="no" class="styled" />
                    <label>
                    	<?php  _e( 'No', 'ultimate-social-media-plus' ); ?>
                    </label>
                </li>
   ...
   <!-- END icon's size and spacing section -->
        ...
        <div class="space">
			...
			<div class="clear">
				...
				<div class="mouseover_field sfsiplus_mastodon_section">
					...
					<input name="sfsi_plus_mastodon_MouseOverText" value="<?php echo ($option5['sfsi_plus_mastodon_MouseOverText']!='') ?  $option5['sfsi_plus_mastodon_MouseOverText'] : '' ;?>" type="text" />
				</div>
			</div>
			<div class="clear">
				<div class="mouseover_field sfsiplus_copylink_section">
					...
					<input name="sfsi_plus_copylink_MouseOverText" value="<?php echo isset($option5['sfsi_plus_copylink_MouseOverText']) && !empty($option5['sfsi_plus_copylink_MouseOverText']) ? esc_attr($option5['sfsi_plus_copylink_MouseOverText']) : 'Copy link'; ?>" type="text" />
				</div>
			</div>
	...
	<div class="row new_wind">
		<h4>Support widget</h4>
		<div class="row_onl"><p>Show the USM support widget on the front-end?</p>
			<ul class="enough_waffling ulSuppressErrors">
		    	<li>
		    		<input name="sfsi_plus_show_admin_popup" <?php echo ($sfsi_plus_show_admin_popup=='yes') ?  'checked="true"' : '' ;?> type="radio" value="yes" class="styled"  />
		    		<label>Yes</label>
		    	</li>
				<li>
					<input name="sfsi_plus_show_admin_popup" <?php echo ($sfsi_plus_show_admin_popup=='no') ?  'checked="true"' : '' ;?> type="radio" value="no" class="styled" />
					<label>No</label>
				</li>
	      	</ul>
      	</div>
	...
	<div class="row new_wind">
		...
		<div class="row_onl"><p>Show more useful tips for more sharing & traffic?</p>
			<ul class="enough_waffling ulSuppressErrors">
		    	<li>
		    		<input name="sfsi_plus_icons_sharing_and_traffic_tips" <?php echo ($sfsi_plus_icons_sharing_and_traffic_tips=='yes') ?  'checked="true"' : '' ;?> type="radio" value="yes" class="styled"  />
		    		<label>Yes</label>
		    	</li>
				<li>
					<input name="sfsi_plus_icons_sharing_and_traffic_tips" <?php echo ($sfsi_plus_icons_sharing_and_traffic_tips=='no') ?  'checked="true"' : '' ;?> type="radio" value="no" class="styled" />
					<label>No</label>
				</li>
	      	</ul>
      	</div>
		...
		<div class="row new_wind">
			<?php include(SFSI_PLUS_DOCROOT . '/views/sfsi_option_view_tifm.php'); ?>
		</div>

...
function sfsi_plus_options_updater2()
{
	...
	$sfsi_plus_mastodon_pageUrl   = isset($_POST["sfsi_plus_mastodon_pageUrl"]) ? esc_url($_POST["sfsi_plus_mastodon_pageUrl"]) : '';
	...
	$up_option2	= array(
		...
		/** Mastodon */
		'sfsi_plus_mastodon_pageUrl' => sanitize_text_field($sfsi_plus_mastodon_pageUrl),
...
function sfsi_plus_options_updater3()
{
	...
	/* Flat color settings */
    $sfsi_plus_rss_bgColor    = isset( $_POST["sfsi_plus_rss_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_rss_bgColor"] ) : '';
    $sfsi_plus_email_bgColor    = isset( $_POST["sfsi_plus_email_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_email_bgColor"] ) : '';
    $sfsi_plus_facebook_bgColor    = isset( $_POST["sfsi_plus_facebook_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_facebook_bgColor"] ) : '';
    $sfsi_plus_twitter_bgColor    = isset( $_POST["sfsi_plus_twitter_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_twitter_bgColor"] ) : '';
    $sfsi_plus_youtube_bgColor    = isset( $_POST["sfsi_plus_youtube_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_youtube_bgColor"] ) : '';
    $sfsi_plus_linkedin_bgColor    = isset( $_POST["sfsi_plus_linkedin_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_linkedin_bgColor"] ) : '';
    $sfsi_plus_pinterest_bgColor    = isset( $_POST["sfsi_plus_pinterest_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_pinterest_bgColor"] ) : '';
    $sfsi_plus_instagram_bgColor    = isset( $_POST["sfsi_plus_instagram_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_instagram_bgColor"] ) : '';
    $sfsi_plus_houzz_bgColor    = isset( $_POST["sfsi_plus_houzz_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_houzz_bgColor"] ) : '';
    $sfsi_plus_ok_bgColor    = isset( $_POST["sfsi_plus_ok_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_ok_bgColor"] ) : '';
    $sfsi_plus_telegram_bgColor    = isset( $_POST["sfsi_plus_telegram_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_telegram_bgColor"] ) : '';
    $sfsi_plus_vk_bgColor    = isset( $_POST["sfsi_plus_vk_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_vk_bgColor"] ) : '';
    $sfsi_plus_wechat_bgColor    = isset( $_POST["sfsi_plus_wechat_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_wechat_bgColor"] ) : '';
    $sfsi_plus_whatsapp_bgColor    = isset( $_POST["sfsi_plus_whatsapp_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_whatsapp_bgColor"] ) : '';
    $sfsi_plus_weibo_bgColor    = isset( $_POST["sfsi_plus_weibo_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_weibo_bgColor"] ) : '';
	$sfsi_plus_copylink_bgColor    = isset( $_POST["sfsi_plus_copylink_bgColor"] )? sanitize_text_field( $_POST["sfsi_plus_copylink_bgColor"] ): '';
	$sfsi_plus_mastodon_bgColor    = isset( $_POST["sfsi_plus_mastodon_bgColor"] ) ? sanitize_text_field( $_POST["sfsi_plus_mastodon_bgColor"] ) : '';
...
function sfsi_plus_options_updater4()
{
    ...
    $sfsi_plus_facebook_enableCache      = isset( $_POST["sfsi_plus_facebook_enableCache"] ) && ($_POST["sfsi_plus_facebook_enableCache"] === true || $_POST["sfsi_plus_facebook_enableCache"] == "true") ? 'yes' : 'no';
	...
	$up_option4 = array(
        ...
        'sfsi_plus_facebook_enableCache'  => sanitize_text_field($sfsi_plus_facebook_enableCache),
...
function sfsi_plus_options_updater5()
{
	...
	$sfsi_plus_copylinkIcon_order   = isset( $_POST["sfsi_plus_copylinkIcon_order"] ) ? intval( $_POST["sfsi_plus_copylinkIcon_order"] ) : '30';
	$sfsi_plus_mastodonIcon_order   = isset( $_POST["sfsi_plus_mastodonIcon_order"] ) ? intval( $_POST["sfsi_plus_mastodonIcon_order"] ) : '28'; 
	...
	$sfsi_plus_follow_icons_language = isset( $_POST["sfsi_plus_follow_icons_language"] ) ? sanitize_text_field( $_POST["sfsi_plus_follow_icons_language"] ) : 'Follow_en_US';
	$sfsi_plus_facebook_icons_language = isset( $_POST["sfsi_plus_facebook_icons_language"] ) ? sanitize_text_field( $_POST["sfsi_plus_facebook_icons_language"] ) : 'Visit_us_en_US';
	$sfsi_plus_twitter_icons_language = isset( $_POST["sfsi_plus_twitter_icons_language"] ) ? sanitize_text_field( $_POST["sfsi_plus_twitter_icons_language"] ) : 'Visit_us_en_US';
	...
	$sfsi_plus_show_admin_popup = isset( $_POST["sfsi_plus_show_admin_popup"] ) ? sanitize_text_field( $_POST["sfsi_plus_show_admin_popup"] ) : 'yes';
	...
	$up_option5 = array(
		...
		'sfsi_plus_copylinkIcon_order'			=> intval($sfsi_plus_copylinkIcon_order),
		'sfsi_plus_linkedinIcon_order'		=> intval($sfsi_plus_linkedinIcon_order),
		'sfsi_plus_mastodonIcon_order'		=> intval($sfsi_plus_mastodonIcon_order),
		...
		'sfsi_plus_show_admin_popup'		=> sanitize_text_field($sfsi_plus_show_admin_popup),
...
function sfsi_plus_getCounts($for_resposive = false)
{
	...
	$option4 = maybe_unserialize(get_option('sfsi_plus_section4_options', 'a:0:{}'));
	$sfsi_plus_section2_options = maybe_unserialize(get_option('sfsi_plus_section2_options', 'a:0:{}'));
	...
	if (isset($option4['sfsi_plus_facebook_countsFrom']) && !empty($option4['sfsi_plus_facebook_countsFrom'])) {
		...
		if ($option4['sfsi_plus_facebook_countsFrom'] == "likes") {
			...
			$scounts['fb_count'] = $socialObj->format_num($fb_data);
	...
	/* get rss count */
		...
		if (isset($option4['sfsi_plus_mastodon_manualCounts']) && !empty($option4['sfsi_plus_mastodon_manualCounts'])) {
...
{
  if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_save_export')) return wp_send_json_error();
...
{
  if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_install_newsletter')) return wp_send_json_error();
  if (!current_user_can('manage_options')) return wp_send_json_error();
...
{
    if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_installDate')) return wp_send_json_error();
    if (!current_user_can('manage_options')) return wp_send_json_error();
...
{
    if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_currentDate')) return wp_send_json_error();
    if (!current_user_can('manage_options')) return wp_send_json_error();
...
{
    if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_showNextBannerDate')) return wp_send_json_error();
    if (!current_user_can('manage_options')) return wp_send_json_error();
...
{
    if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_cycleDate')) return wp_send_json_error();
    if (!current_user_can('manage_options')) return wp_send_json_error();
...
{
    if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_loyaltyDate')) return wp_send_json_error();
    if (!current_user_can('manage_options')) return wp_send_json_error();
...
{
    if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_banner_global_pinterest')) return wp_send_json_error();
    if (!current_user_can('manage_options')) return wp_send_json_error();
...
{
    if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_banner_global_firsttime_offer')) return wp_send_json_error();
    if (!current_user_can('manage_options')) return wp_send_json_error();
...
{
    if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_banner_global_social')) return wp_send_json_error();
    if (!current_user_can('manage_options')) return wp_send_json_error();
...
{
    if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_banner_global_load_faster')) return wp_send_json_error();
    if (!current_user_can('manage_options')) return wp_send_json_error();
...
{
    if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_banner_global_shares')) return wp_send_json_error();
    if (!current_user_can('manage_options')) return wp_send_json_error();
...
{
    if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_banner_global_gdpr')) return wp_send_json_error();
    if (!current_user_can('manage_options')) return wp_send_json_error();
...
{
    if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_banner_global_http')) return wp_send_json_error();
    if (!current_user_can('manage_options')) return wp_send_json_error();
...
{
    if (!wp_verify_nonce($_POST['nonce'], 'sfsi_plus_banner_global_upgrade')) return wp_send_json_error();
    if (!current_user_can('manage_options')) return wp_send_json_error();
